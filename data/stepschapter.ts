...
export const ChapterSteps = [
    ...
    },
    {
        ...
        exerciseTwoStepOneInfo: 'Open Main Menu and open Python 3 (IDLE) click File and New FileSave the file as trapezoidArea.py by clicking File and Save As  then choose Home>pi<p># - to comment out</p>',
        ...
        exerciseTwoStepFourInfo: '<p>We are making different variables, but how will the reader see it?</p><p>We must send, or “print” our messages to the screen so that the reader can see the calculated area of a trapezoid, using the print()function.</p><p>Type into the Python file:</p><p>print("Area is:", area)</p><p>Words will be sent to the screen as they appear in the quotes using this command.</p><p>See your progress: Save then click Run and Run Module Now you should see your variables printed out here.',
        exerciseTwoIDE: '<iframe  src="https://trinket.io/embed/python/298de446f7" width="75%" height="500"></iframe>'
    },
    {
        id: 7,
        stepOne:'Step 1: Create a new File',
        stepOneDetails: '<p>We will be using same problem as Video 5 Exercise #2.</p><p>If you would like to use the same file from Video 5 Exercise #2, you can skip over Step 1.</p><p>If not, please create a duplicate file of BankATM.py from Video 5 Exercise #2.</p>',
